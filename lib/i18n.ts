...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "editor.formatRichText": "Rich text",
    "editor.formatMarkdown": "Markdown",
    "editor.formatSwitchLocked":
      "Switch formats before you start writing. Once content exists, the format stays locked.",
    "editor.markdownInput": "Markdown",
    "editor.markdownPreview": "Preview",
    "editor.insertImage": "Insert image",
    "editor.codeLanguage": "Language",
    "editor.turnIntoParagraph": "Turn into paragraph",
    "editor.slashParagraph": "Paragraph",
  ...
  pt: {
    ...
    "editor.formatRichText": "Texto rico",
    "editor.formatMarkdown": "Markdown",
    "editor.formatSwitchLocked":
      "Troque o formato antes de começar a escrever. Depois que houver conteúdo, o formato fica travado.",
    "editor.markdownInput": "Markdown",
    "editor.markdownPreview": "Prévia",
    "editor.insertImage": "Inserir imagem",
    "editor.codeLanguage": "Linguagem",
    "editor.turnIntoParagraph": "Transformar em parágrafo",
    "editor.slashParagraph": "Parágrafo",
    "editor.slashHeading2": "Título 2",
    "editor.slashHeading3": "Título 3",
    "editor.slashQuote": "Citação",
    "editor.slashCodeBlock": "Bloco de código",
    "editor.slashDivider": "Divisor",
    "editor.slashBulletList": "Lista com marcadores",
    "editor.slashNumberedList": "Lista numerada",
    "editor.slashImage": "Imagem",
